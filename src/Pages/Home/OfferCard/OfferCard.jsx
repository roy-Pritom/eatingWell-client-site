            ...
            <div className='d-flex flex-md-row flex-column gap-5 justify-content-center align-items-center'>
                <div className="">
                    ...
                    <div className="d-flex align-items-center gap-5">
                        <button className='btn btn-success px-md-4 px-2 py-2 text-white fs-md-5 fw-md-bold fw-semibold fs-6'>Order Now</button>
                ...
                <div className="">
                    <img src="https://xpressrow.com/html/frudbaz/assets/img/offer/offer_img.png" alt="" className='cart' />
                </div>
